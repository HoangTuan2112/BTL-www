package com.NguyenHoangTuan.ecommerce.utils;
...
public final class EmailMessages {
    ...
    public static String orderSuccessfullyPlacedMessage(
        ...
        return "Dear " + "<strong>" + name + "</strong>" +
                "<br><br>" +
                "Your order with order id <strong>" + orderId.substring(6) + "</strong> is successfully placed and we have received the order payment of vnd  " + amount +
    ...
    public static String orderSuccessfullyDeliveredMessage(
        ...
        return "Dear " + "<strong>" + name + "</strong>," +
                ...
                "'<br>" +
                "<strong>Order price: </strong> vnd" + orderPrice +
                "<br>" +
