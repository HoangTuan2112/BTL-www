...
public class FirebaseServiceImpl implements FirebaseService {
    ...
    public boolean delete(final String fileUrl) {
        ...
        try {
            ...
            final BlobId blobId = BlobId.of("storageimage-21454.appspot.com", fileName);
    ...
    private String uploadFile(File file, String fileName) throws IOException {
        ...
        return String.format("https://firebasestorage.googleapis.com/v0/b/storageimage-21454.appspot.com/o/%s?alt=media", URLEncoder.encode(fileName, String.valueOf(StandardCharsets.UTF_8)));
    }
